...
#define GET_FC_MACRO(_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,NAME,...) NAME
#define FILL_CHARS(arr, ...) GET_FC_MACRO(__VA_ARGS__, FC_10, FC_9, FC_8, FC_7, FC_6, FC_5, FC_4, FC_3, FC_2, FC_1)(arr, __VA_ARGS__)
